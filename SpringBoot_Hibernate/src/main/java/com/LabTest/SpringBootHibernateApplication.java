	...
	public static void main(String[] args) {
		...
		while (c == 'y') {
			...
			case 1: {
				...
				p1.setPname(p_name);
				System.out.println("Enter product brand to insert...");
				String pbrand = sc.next();
				p1.setPbrand(pbrand);
				System.out.println("Enter product price to insert...");
			...
			//case 2
			case 2: {
				System.out.println("choose option 1st to update product name(productname) ");
				System.out.println("choose option 2nd to update product brand(productbrand) ");
				System.out.println("choose option 3rd to update product product price");
				...
				case 1: {
					...
					pr.save(p21);
					System.out.println("updation of product name is Sucessfully");
					break;
				}
				case 2: {
				...
				case 3: {
					...
					System.out.println("Enter new product price(pprice) to update:");
					Double new_price = sc.nextDouble();
					p23.setPprice(new_price);
					pr.save(p23);
			...
			//case 3
			case 3: {
				System.out.println("Enter the name whose record deleted...");
				String del_name = sc.next();
				int ii = pr.removeByPname(del_name);
				if (ii == 0) {
					System.out.println("product name not available in the table... ");
				} else {
